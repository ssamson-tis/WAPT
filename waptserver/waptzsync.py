...
mainRepo = "http://wapt.tranquil.it/wapt/"
...
def scanPackages():
  if not os.path.exists(waptDir+'wapt-scanpackages.py'):
      urllib.urlretrieve(mainRepo+"wapt-scanpackages.py'", waptDir+'wapt-scanpackages.py')
  if not os.path.exists(waptDir+'waptpackage.py'):
